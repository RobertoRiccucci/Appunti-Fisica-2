...
Esprimendo la \ref{eq: Legge di Faraday} mediante integrali dei campi $\mathbf{E}'$ e $\mathbf{B}$, si ha 

\begin{equation} \label{eq: L. Faraday integrale}
    \oint_C \mathbf{E'} \cdot d \mathbf{l} = - \frac{d}{dt} \left(\int_{\Sigma} \mathbf{B} \cdot \mathbf{u}_n \ d\Sigma \right)
\end{equation}
