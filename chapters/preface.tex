...
In questi appunti non sono presenti esercizi. Per la risoluzione di problemi si consiglia \emph{"Problems in Classical Electromagnetism. 203 Exercises with Solutions"} di \emph{Andrea Macchi, Giovanni Moruzzi e Francesco Pegoraro}: il testo copre l'intero programma di Fisica 2 e non solo, costituendo un riferimento completo per chiunque voglia approfondire l'elettromagnetismo classico.\\
